...
var Subscribers = (function (_super) {
    ...
    Subscribers.prototype.getPreference = function (subscriberId_1) {
        return __awaiter(this, arguments, void 0, function (subscriberId, options) {
            var includeInactiveChannels, searchParams, searchParamsString, url;
            if (options === void 0) { options = {}; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        includeInactiveChannels = options.includeInactiveChannels;
                        searchParams = new URLSearchParams();
                        if (includeInactiveChannels) {
                            searchParams.append('includeInactiveChannels', 'true');
                        }
                        searchParamsString = searchParams.toString();
                        url = "/subscribers/".concat(subscriberId, "/preferences");
                        if (searchParamsString) {
                            url += "?".concat(searchParamsString);
                        }
